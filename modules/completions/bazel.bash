...
--experimental_restrict_named_params
--noexperimental_restrict_named_params
...
--noincompatible_disallow_legacy_java_provider
...
--noincompatible_disallow_native_in_build_file
...
--noincompatible_no_transitive_loads
...
--noincompatible_string_join_requires_strings
--incompatible_use_toolchain_providers_in_java_common
--noincompatible_use_toolchain_providers_in_java_common
...
--experimental_use_python_toolchains
--noexperimental_use_python_toolchains
...
--noincompatible_java_coverage
--incompatible_list_based_execution_strategy_selection
--noincompatible_list_based_execution_strategy_selection
...
--noincompatible_use_aapt2_by_default
--incompatible_use_remote_host_java_toolchain
--noincompatible_use_remote_host_java_toolchain
--incompatible_use_remote_java_toolchain
--noincompatible_use_remote_java_toolchain
--incompatible_use_toolchain_providers_in_java_common
--noincompatible_use_toolchain_providers_in_java_common
--incompatible_windows_escape_jvm_flags
--noincompatible_windows_escape_jvm_flags
